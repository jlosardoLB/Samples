...
var gExtensionID = window.__adobe_cep__.getExtensionId();
...
window.__adobe_cep__.addEventListener("com.adobe.PhotoshopJSONCallback" + gExtensionID, PhotoshopCallbackUnique);
...
function Initialize() {
    window.__adobe_cep__.dispatchEvent({
        type: "com.adobe.PhotoshopPersistent",
        scope: "APPLICATION",
        appId: undefined,
